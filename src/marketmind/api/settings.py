...
class APISettings:
    ...
    def from_environment(cls):
        ...
        return cls(environment=os.getenv("MARKETMIND_ENV","development"),artifact_root=Path(os.getenv("MARKETMIND_ARTIFACT_ROOT",".")),log_level=os.getenv("MARKETMIND_LOG_LEVEL","INFO"),cors_origins=origins)
